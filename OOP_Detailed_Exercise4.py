"""
Directions: 
Within your project or package named Java-exercises (create it if it does not already exist). Within that, create a class file for each class and test it using a main() method.  Sample Java main method follows:
